        ...
        <div className="card-wrapper">
          				{
							Array.from({length:2}).map((_,i)=>{
								return (<div className="card" onClick={()=>applyStyle(i, "layout-2",0)}>
									<div className="frame" >
						...
						}
						{
							Array.from({length:5}).map((_,i)=>{
								return (<div className="card" onClick={()=>applyStyle(i,"layout-2",1)}>
									<div className="frame" >
										<div className="innerFrame">
											<div className="background">
											</div>
											<div className="dropboxParent">
												<div className="dropbox">
													<div className={`centeredDropbox layout-2 two-canvases styletwo-${i}`} >
														<div className="uploadBox" >
															<div className='stack2 none'>
																{
																	preview &&
           				...
           				{
							Array.from({length:5}).map((_,i)=>{
								return (<div className="card" onClick={()=>applyStyle(i,"layout-2",2)}>
									<div className="frame" >
										<div className="innerFrame">
											<div className="background">
											</div>
											<div className="dropboxParent">
												<div className="dropbox">
													<div className={`centeredDropbox three-canvases layout-2 stylethree-${i}`} >
														<div className="uploadBox">
															<div className='stack2 none'>
																{
																	preview &&
						...
						{
							Array.from({length:2}).map((_,i)=>{
								return (<div className="card" onClick={()=>applyStyle(i+2,"layout-2",0)}>
									<div className="frame" >
										<div className="innerFrame">
											<div className="background">
											</div>
